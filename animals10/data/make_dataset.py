...
def save_batches(set_type, inputs, targets):
    ...
    for input_batch, target_batch in zip(inputs, targets):
        ...
        torch.save(
            torch.utils.data.TensorDataset(data, labels), f"data/processed/{set_type}/{set_type}_{batch_counter}.pt"
        )
...
if __name__ == "__main__":
    ...
    # create sets
    input_train, target_train, input_val, target_val, input_test, target_test = create_splits(
        image_names, category_names
    )
