...
from animals10.train_model import decide_filename
...
def test_data_loading(hydra_config):
    ...
    """
    train_loader = Loader().load(hydra_config.hyperparameters_training, batch_amount=hydra_config.hyperparameters_training.training_batch, folder_path="data/processed/train")
    validation_loader = Loader().load(hydra_config.hyperparameters_training, batch_amount=hydra_config.hyperparameters_training.validation_batch, folder_path="data/processed/val")
